...
const productsRepo = {
  ...
  updateProduct: async (productId: string, args: Partial<CreateProductArgs>): Promise<Product[]> => {
...
export const useCreateProduct = () => {
  ...
  return useMutation((args: CreateProductArgs) => {
...
export const useUpdateProduct= (productId: string) => {
  const queryClient = useQueryClient();
  return useMutation((args: Partial<CreateProductArgs>) => {
